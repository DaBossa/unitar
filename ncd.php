...
?>
        <section class="hero-pilar bg-<?php echo $page_class ?>">
            <div class="hero-pilar-image">
                <div class="hero-icon-text">
                    <h1 class="bg-<?php echo $page_class ?>"><a href="https://defeat-ncd.org/" target="_blank"><?php echo $titulo ?></a>
                        <!--<i><?php include('assets/images/pillar-hero-icon-'.$page_class.'.svg'); ?></i>-->
                    </h1>
                </div>
                <div class="image-mask">
                    <span>© Image: Jesper Westley/World Diabetes Foundation</span>
                    ...
                    <div class="col-10 col-md-6 offset-md-6 d-flex flex-column align-items-start justify-content-center">
                        <div class="pilar-hero-text pilar-hero-text-1 d-flex align-items-end">
                            <div class="inner font-size-3">
                                ...
                                <p>Ensuring healthy lives and <br>promoting well-being at all ages</p>
                            </div>
                        </div>
                        <div class="pilar-hero-text pilar-hero-text-2 pb-0">
                            <div class="inner font-size-3">
                                <p>Promoting universal health coverage <br>for non-communicable diseases</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="pilar-infos pilar-infos-2 bg-<?php echo $page_class ?> text-white">
            <img src="assets/images/pilar-hero-detalhe-3.svg" alt="" class="hero-pilar-detalhe-3">
            <div class="bg-white mt-n1">
                <div class="container pb-lg-5">
                    <div class="row justify-content-md-end align-items-center pt-4 justify-content-center">
        ...
        <section>
            <div class="container mt-5 mb-lg-n5">
                <div class="row">
                    <div class="anima-type1 col-11 col-md-9 col-lg-7 mx-auto font-size-2">
                        <p><strong>Launched in 2018, The Defeat-NCD Partnership is a ‘public–private–people’ partnership that works with governments, multilateral agencies, civil society, academia, philanthropic foundations and the private sector towards achieving universal health coverage (UHC) for Non-Communicable Diseases (NCDs) by 2030.</strong></p>
                    </div>
                </div>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1891.328 342.726"><path d="M-47.035,60.828C-545.1,633.014-1387.1,55.994-1933.979,267.254c-4.1,1.582-4.117,0-4.117,0s-.6-20.422,0-20.678C-1406.48,20.123-639.248,601.619-47.035-20.325V45.8" transform="translate(1938.363 20.325)" opacity="0.2"/></svg>
        </section>
        <section>
            ...
            <div class="container pt-xl-5 mt-5 c-pb">
                <div class="row flex-column align-items-center no-gutters pb-5">
                    <div class="col-xl-8 highlights-item">
                        ...
                        <div class="content">
                            <p>Carried out <strong>preparatory programming missions to Rwanda, Myanmar, India, Haiti, Zimbabwe, Bangladesh, Saint Lucia, and Trinidad and Tobago, Kenya, and Uganda</strong>. These missions informed the identification of the initial two priority countries for 2020 programmatic support.</p>
                        </div>
                    </div>
                    <div class="col-xl-8 highlights-item">
