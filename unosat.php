        ...
        <section class="hero-pilar bg-<?php echo $page_class ?>">
            <div class="hero-pilar-image">
                <div class="hero-icon-text">
                    <h1 class="bg-<?php echo $page_class ?>"><a href="https://www.unitar.org/sustainable-development-goals/satellite-analysis-and-applied-research" target="_blank"><?php echo $titulo ?></a>
                    ...
                    <div class="col-10 col-md-6 offset-md-6 d-flex flex-column align-items-start justify-content-center">
                        <div class="pilar-hero-text pilar-hero-text-1 d-flex align-items-end">
                            <div class="inner font-size-3">
                                ...
                                <p>Optimizing the use <br>of technology and <br>supporting coherence <br>for the 2030 Agenda</p>
                            </div>
                        </div>
                        <div class="pilar-hero-text pilar-hero-text-2">
                            <div class="inner font-size-3">
                                <p>Optimize the use of new <br>technology, including <br>geospatial technologies <br>for evidence-based <br>decision-making</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="pilar-infos bg-<?php echo $page_class ?> text-white">
            ...
            <div class="container c-pb">
                ...
                <div class="row justify-content-md-center align-items-center c-pt">
                    ...
                    <div class="activity-item">
                        <img src="assets/images/pilar-icon-09@2x.png" alt="">
                    </div>
                    <div class="activity-item">
                    ...
                    <div class="col-xl-9 row bg-light mx-auto p-0 inner">
                        <div class="content">
                            ...
                            <ul class="items-numbers">
                                <li class="data-events" data-info="24">
                                    <h4>24</h4>
                                    <h5>Events</h5>
                                </li>
                                <li class="data-events-days" data-info="60">
                                    <h4>60</h4>
                                    <h5>Event days</h5>
                                </li>
                                <li class="data-beneficiaries" data-info="718">
                                    <h4>718</h4>
                                    <h5>Beneficiaries</h5>
                                </li>
                            </ul>
                        ...
                        <div class="content">
                            ...
                            <ul class="items-numbers">
                                <li class="data-learning-events" data-info="22">
                                    <h4>22</h4>
                                    <h5>Learning events</h5>
                                </li>
                                <li class="data-learners" data-info="607">
                                    <h4>607</h4>
                                    <h5>Learners</h5>
                                </li>
                                <li class="data-certificates" data-info="538">
                                    <h4>538</h4>
                                    <h5>Certificates*</h5>
                                </li>
                            </ul>
            ...
            <div class="container position-relative text-white mt-n5 c-pb">
                <div class="row align-items-center">
                    <div class="col-10 offset-1 col-md-5 offset-md-0 offset-xl-1">
                        <div class="image">
                            <img src="assets/images/hero-pilar-<?php echo $page_class ?>-img-01.jpg" alt="Bormy Chanthong - Cambodia"> 
                        </div>
                        <div class="image-desc bg-<?php echo $page_class ?>">
                            <h3>Bormy Chanthong</h3>
                            <p>Cambodia</p>
                        </div>
                    </div>
