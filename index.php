...
?>
        <section class="hero">
            ...
            <div class="container position-relative text-white">
                <div class="row align-items-end">
                    <div class="col-6 col-md-4 col-lg-4 offset-1">
                        <h1>2019 <strong>Results Report</strong></h1>
                    </div>
                </div>
            </div>
        </section>
        <section id="foreword" class="bg-primary bg-wave-top pb-4 pb-md-0">
            <div class="bg-primary bg-wave"></div>
            <div class="container position-relative text-white c-pt c-pb">
                <div class="row align-items-center">
                    <div class="col-10 offset-1 col-md-5 offset-md-0 offset-xl-1">
                        <div class="image">
                            <img src="assets/images/img-Nikhil_Seth.jpg" alt="Nikhil Seth - UNITAR Executive Director">
                        </div>
                        <div class="image-desc bg-primary">
                            <h3>Nikhil Seth</h3>
                            <p>United Nations Assistant Secretary-General</p>
                            <p>UNITAR Executive Director</p>
                        </div>
                    </div>
                    <div class="col-10 col-md-7 col-xl-6 offset-1 offset-md-0 text-desc">
                        <p>I am pleased to present the 2019 Results Report of the United Nations Institute for Training and Research (UNITAR). At UNITAR, we help Member States and other United Nations stakeholders implement the 2030 Agenda for Sustainable Development by providing modern and innovative learning solutions that meet internationally recognized quality standards. Our activities, and the results they produce, vary tremendously in scale and impact.</p>
                        <p class="text-right"><a href="/download/unitar_results_report_2019.pdf#page=5" class="btn btn-light btn-icon btn-right" target="_blank"><span>Read more</span> <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 18"><path transform="translate(9.849 9.849)" d="M-.228.1l-7.407,7.66a1.267,1.267,0,0,1-1.834,0,1.374,1.374,0,0,1,0-1.9L-2.978-.848-9.469-7.56a1.374,1.374,0,0,1,0-1.9,1.267,1.267,0,0,1,1.834,0L-.228-1.8a1.374,1.374,0,0,1,0,1.9" /></svg></i></a></p>
                    </div>
                </div>
            </div>
        </section>
        <div class="position-relative d-none d-md-block">
            <img src="assets/images/detalhe-image.png" alt="" class="detalhe-image">
        </div>
        <section id="primary-output" class="bg-light bg-wave-top pb-4 pb-md-0">
            <div class="bg-light bg-wave"></div>
            <div class="container position-relative c-pt c-pb">
                <div class="row align-items-end">
                    <div class="col-md-9 col-lg-6 mx-auto">
                        <h2 class="anima-type1">Trained Beneficiaries</h2>
                        <p class="anima-type1">We provided learning, training and knowledge sharing services to 133,421 individuals in 2019, representing a 57% increase from 2018 figures.</p>
                        <p class="anima-type1">69% of our training beneficiaries last year were associated with events having specific learning outcomes, representing an increase of 52% in this category.</p>
                        <div class="grafico-1-mobile pt-lg-5 pb-lg-5 mb-5 mt-5 d-lg-none">
                            <?php include('assets/images/grafico-1-mobile.svg'); ?>
                        </div>
                        <div class="grafico-1 pt-lg-5 pb-lg-5 mb-5 mt-5 d-none d-lg-block">
                            <?php include('assets/images/grafico-1.svg'); ?>
                        </div>
                        <p class="anima-type1">This increase is attributed largely to the continued delivery of the introductory e-Learning course on climate change administered in partnership with agencies of <a href="https://www.uncclearn.org/" target="_blank">the One UN Climate Change Learning Partnership</a>.</p>
                        <p class="anima-type1">The proportion of participants from broader knowledge-sharing and other events (e.g. conferences, public lectures, meetings) decreased during the 2018 to 2019 period (in line with the Institute’s strategy to emphasize learning solutions).</p>
                    </div>
                    <div class="w-100"></div>
                    <div class="col-md-8 col-lg-6 mx-auto mt-5 pt-5">
                        <h2 class="anima-type1">Beneficiaries by strategic objectives</h2>
                    </div>
                    <div class="w-100"></div>
                    <div class="col-lg-8 mx-auto mt-lg-5 pt-5">
                        <div class="grafico-2-mobile d-md-none">
                            <?php include('assets/images/grafico-2-mobile.svg'); ?>
                        </div>
                        <div class="grafico-2 d-none d-md-block">
                            <?php include('assets/images/grafico-2.svg'); ?>
                        </div>
                    </div>
        ...
        <section>
            <div class="container c-pt c-pb">
                <div class="row">
                    <div class="col-md-8 col-lg-6 mx-auto">
                        <h2 class="anima-type1">Regional Breakdown of Learning-related Beneficiaries</h2>
                    </div>
                    <div class="w-100"></div>
                    <div class="col-12 grafico-3-mobile pt-5 mt-5 d-lg-none">
                        <img src="/assets/images/grafico-3-mobile.png" alt="">
                    </div>
                    <div class="col-12 grafico-3 pt-5 mt-5 d-none d-lg-block">
                        <?php include('assets/images/grafico-3.svg'); ?>
                    </div>
                </div>
            </div>
        </section>
        <section>
            <div class="bg-wave-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1890.494 476.398">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-9 offset-md-3 col-lg-5 offset-lg-4 pt-5 pb-4 pt-5 pt-lg-0">
                        <p class="anima-type1"><strong class="marker">75%</strong> of learning related beneficiaries came from <strong class="marker">developing countries</strong> and <strong class="marker">23% from countries in special situations</strong>, comprised of the least-developed countries, the landlocked developing countries and the small island developing States.</p>
                        <p class="anima-type1">80% of our beneficiaries in 2019 come from Africa (28%), Latin America and Caribbean (36%) and Asia and Pacific (16%).</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="bg-light">
            <div class="bg-wave-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1890.002 255.13">
            ...
            <div class="container c-pt c-pb">
                <div class="row pb-5">
                    <div class="col-md-8 col-lg-6 offset-md-2 offset-lg-3">
                        <h2 class="anima-type1">Number of Events and Delivery Mode</h2>
                        <p class="anima-type1">UNITAR’s overall beneficiaries took part in <strong class="marker">671 events,</strong> equivalent to some <strong class="marker">19,847 event</strong> days over the calendar year.</p>
                    </div>
                </div>
                <div class="row justify-content-center text-center pt-xl-5 icon-text">
                    <div class="col-6 col-md-4 col-lg-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 104.572 80.97"><path id="icon-face_to_face" d="M0,0V-20.037a17.809,17.809,0,0,1-5.866-13.1c0-10.241,8.991-18.549,20.08-18.549S34.3-43.38,34.3-33.139c0,.282-.012.562-.026.84l2.8,4.487,3.689,5.9H36.1v7.322a5.219,5.219,0,0,1-5.414,5H22.111V0M90.194,0V-20.037a17.8,17.8,0,0,0,5.868-13.1c0-10.241-8.988-18.549-20.082-18.549S55.9-43.38,55.9-33.139c0,.282.009.562.023.84l-2.8,4.487-3.691,5.9H54.1v7.322a5.219,5.219,0,0,0,5.414,5h8.576V0" transform="translate(7.188 65.01)" fill="none" stroke="#4d8cca" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.644"/></svg></i>
                        <h3>Face-to-Face</h3>
                        <h4 id="contador1">59%</h4>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3">
                        <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.969 80.97">
                        ...
                        <h3>E-learning</h3>
                        <h4 id="contador2">38%</h4>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 mt-5 mt-md-0">
                        <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.969 80.97">
                            <path id="icon-e_learning" d="M0,0V-42.432a4.9,4.9,0,0,1,4.895-4.9H31.9m-.636,8.779a7.3,7.3,0,0,0-4.341,6.674c-.016,4.373.1,8.909,2.448,11.341v.016a3.276,3.276,0,0,1-2.007,3.035l-7,2.937a6.605,6.605,0,0,0-4.047,6.087V0m35.9,0V-8.458a6.605,6.605,0,0,0-4.047-6.087l-7-2.937A3.279,3.279,0,0,1,39.163-20.5v-.049c2.04-2.121,2.4-5.825,2.431-9.643m26.941-2.954V0m-.362-66.541a17.95,17.95,0,0,0-25.385,0,17.955,17.955,0,0,0-2.321,22.533l-3.448,8.621,8.621-3.449a17.953,17.953,0,0,0,22.533-2.321A17.948,17.948,0,0,0,68.173-66.541ZM-4.895,0V1.632A4.895,4.895,0,0,0,0,6.527H68.535A4.895,4.895,0,0,0,73.43,1.632V0Z" transform="translate(6.217 73.121)" fill="none" stroke="#4D4945" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.644"/>
                          </svg> / <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 104.572 80.97"><path id="icon-face_to_face" d="M0,0V-20.037a17.809,17.809,0,0,1-5.866-13.1c0-10.241,8.991-18.549,20.08-18.549S34.3-43.38,34.3-33.139c0,.282-.012.562-.026.84l2.8,4.487,3.689,5.9H36.1v7.322a5.219,5.219,0,0,1-5.414,5H22.111V0M90.194,0V-20.037a17.8,17.8,0,0,0,5.868-13.1c0-10.241-8.988-18.549-20.082-18.549S55.9-43.38,55.9-33.139c0,.282.009.562.023.84l-2.8,4.487-3.691,5.9H54.1v7.322a5.219,5.219,0,0,0,5.414,5h8.576V0" transform="translate(7.188 65.01)" fill="none" stroke="#4D4945" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.644"/></svg></i>
                        <h3>Blended learning</h3>
                        <h4 id="contador3">3%</h4>
                    </div>
                </div>
            </div>
        </section>
