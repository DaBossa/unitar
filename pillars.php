...
$titulo = "";
$descricao = "";
$body_class = "pilar bg-people";
include('header.php');

?>
        <section class="hero-pilar bg-people">
            ...
            <div class="hero-pilar-image">
                <div class="hero-icon-text">
                    <h1 class="bg-people">Satellite Analysis and Applied Research
                        <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 339.993 290">
                ...
                <div class="image-mask">
                    <div class="image-inner" style="background-image: url(assets/images/hero-pilar-people.jpg);"></div>
                </div>
            </div>
        ...
        <section class="pilar-infos bg-people text-white">
                    ...
                    <div class="col-md-8 col-lg-5 col-xl-6 offset-xl-4">
                        <div class="row">
                            ...
                            <div class="infos-container">
                                ...
                                <p>were associated with the </br>People Pillar activities.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center c-pt">
            ...
            <div class="container pt-5 mt-5 c-pb">
                <div class="row flex-column align-items-center no-gutters pb-5">
                    <div class="col-md-8 col-lg-7 col-xl-6 highlights-item">
                        <img src="assets/images/pilar-people-icon-hl-01.svg" alt="">
                        <div class="content">
                    ...
                    <div class="col-md-8 col-lg-7 col-xl-6 highlights-item">
                        <img src="assets/images/pilar-people-icon-hl-02.svg" alt="">
                        <div class="content">
                    ...
                    <div class="col-md-8 col-lg-7 col-xl-6 highlights-item">
                        <img src="assets/images/pilar-people-icon-hl-03.svg" alt="">
                        <div class="content">
                    ...
                    <div class="col-md-8 col-lg-7 col-xl-6 highlights-item">
                        <img src="assets/images/pilar-people-icon-hl-04.svg" alt="">
                        <div class="content">
                    ...
                    <div class="col-md-8 col-lg-7 col-xl-6 highlights-item">
                        <img src="assets/images/pilar-people-icon-hl-05.svg" alt="">
                        <div class="content">
                    ...
                    <div class="col-md-8 col-lg-7 col-xl-6 highlights-item">
                        <img src="assets/images/pilar-people-icon-hl-06.svg" alt="">
                        <div class="content">
                    ...
                    <div class="w-100"></div>
                    <p class="text-right"><a href="" class="btn btn-people btn-color btn-icon btn-right"><span>Read more</span> <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 18"><path transform="translate(9.849 9.849)" d="M-.228.1l-7.407,7.66a1.267,1.267,0,0,1-1.834,0,1.374,1.374,0,0,1,0-1.9L-2.978-.848-9.469-7.56a1.374,1.374,0,0,1,0-1.9,1.267,1.267,0,0,1,1.834,0L-.228-1.8a1.374,1.374,0,0,1,0,1.9" /></svg></i></a></p>
                </div>
            </div>
        </section>
        <section id="testimonial-1" class="bg-people bg-wave-top">
            <div class="bg-people bg-wave"></div>
            <div class="container position-relative text-white mt-n5 c-pb">
                <div class="row align-items-center">
                    <div class="col-10 offset-1 col-md-5 offset-md-0 offset-xl-1">
                        <div class="image">
                            <img src="assets/images/hero-pilar-people-img-01.jpg" alt="Nikhil Seth - UNITAR Executive Director">
                        </div>
                        <div class="image-desc bg-people">
                            <h3>Alexander Taylor</h3>
                            <p>United States of America</p>
                        </div>
                    </div>
                    <div class="col-10 col-md-7 col-xl-6 offset-1 offset-md-0 text-desc font-size-3">
                        <p>“The conference provided me with the opportunity to engage in intergenerational dialogue with an international community. I came to understand the intersectionality of the Sustainable Development Goals that we, as youth, inherit and as social entrepreneurs develop.”</p>
