        ...
        <section class="hero-pilar bg-<?php echo $page_class ?>">
            <div class="hero-pilar-image">
                <div class="hero-icon-text">
                    <h1 class="bg-<?php echo $page_class ?>"><a href="https://www.unitar.org/sustainable-development-goals/prosperity" target="_blank"><?php echo $titulo ?></a>
                    ...
                    <div class="col-10 col-md-6 offset-md-6 d-flex flex-column align-items-start justify-content-center">
                        <div class="pilar-hero-text pilar-hero-text-1 d-flex align-items-end">
                            <div class="inner font-size-3">
                                ...
                                <p>Promote inclusive <br>and sustainable <br>economic growth</p>
                            </div>
                        </div>
                        <div class="pilar-hero-text pilar-hero-text-2">
                            <div class="inner font-size-3">
                                <p>Help countries achieve <br>inclusive and sustainable <br>economic growth</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-9 row bg-light mx-auto p-0 inner">
                        <div class="content">
                            ...
                            <ul class="items-numbers">
                                <li class="data-events" data-info="37">
                                    <h4>37</h4>
                                    <h5>Events</h5>
                                </li>
                                <li class="data-events-days" data-info="248">
                                    <h4>248</h4>
                                    <h5>Event days</h5>
                                </li>
                                <li class="data-beneficiaries" data-info="829">
                                    <h4>829</h4>
                                    <h5>Beneficiaries</h5>
                                </li>
                            </ul>
                        ...
                        <div class="content">
                            ...
                            <ul class="items-numbers">
                                <li class="data-learning-events" data-info="24">
                                    <h4>24</h4>
                                    <h5>Learning events</h5>
                                </li>
                                <li class="data-learners" data-info="337">
                                    <h4>337</h4>
                                    <h5>Learners</h5>
                                </li>
